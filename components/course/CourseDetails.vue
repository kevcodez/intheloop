<template>
  <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
    <div class="md:col-span-1 items-center flex justify-center">
      <img :src="course.info.image" class="self-center object-contain max-h-40 md:max-h-60" />
    </div>
    <div class="md:col-span-3">
      ...
      <div class="mt-5 flex">
        <a class="button dark text-lg" target="_blank" :href="course.info.url">Get the course</a>
      </div>
    </div>
  </div>
</template>
