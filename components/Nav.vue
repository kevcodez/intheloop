  ...
  <nav class="bg-white shadow">
      ...
      <div class="flex justify-between h-16">
        <div class="flex">
          ...
          <div class="hidden sm:ml-6 sm:flex sm:space-x-8">
            <nuxt-link v-for="navItem in navItems" :key="navItem.label" :to="navItem.path"
    ...
    <div class="sm:hidden" id="mobile-menu" v-if="mobileMenuOpen">
      <div class="pt-2 pb-3 space-y-1">
        <nuxt-link @click.native="toggleMobileMenu" v-for="navItem in navItems" :key="navItem.label" :to="navItem.path"
