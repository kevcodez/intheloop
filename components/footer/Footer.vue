  ...
  <footer class="mt-20 bg-gray-800">
    <div class="px-4 py-12 mx-auto max-w-7xl 2xl:max-w-[120rem] sm:px-6 lg:py-12 lg:px-8">
      <div class="md:flex md:items-center md:justify-between">
        ...
        <div class="self-center mt-8 text-center text-white self-stat md:order-1 md:mt-0 md:text-left">
          <p>
        ...
        <div class="self-center mt-8 text-center text-white md:mt-0 md:text-left md:order-3">
          <div class="flex flex-row justify-center mt-3 space-x-6">
            <a href="https://twitter.com/kevcodez" class="text-gray-400 hover:text-gray-300">
            ...
            <a href="https://github.com/kevcodez/intheloop" class="text-gray-400 hover:text-gray-300">
